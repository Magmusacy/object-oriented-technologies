...
public class GalleryController {
    ...
    public void initialize() {
        ...
        ReadOnlyObjectProperty<Photo> photoReadOnlyObjectProperty = imagesListView.getSelectionModel().selectedItemProperty();
        photoReadOnlyObjectProperty.addListener((observable, oldValue, newValue) -> {
            bindSelectedPhoto(newValue, oldValue);
        });
    }
    ...
    private void bindSelectedPhoto(Photo selectedPhoto, Photo oldPhoto) {
        if (oldPhoto != null) {
            imageNameField.textProperty().unbindBidirectional(oldPhoto);
        }
